...
export const title = "Highlight Text";
...
function HighlightText({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block px-2 py-1 rounded-lg bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-500/80 dark:to-blue-300/80`,
        className,
      )}
      {...(props as any)}
    >
