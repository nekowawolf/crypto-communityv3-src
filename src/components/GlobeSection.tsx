...
export function GlobeDemo() {
  ...
  const sampleArcs = [
    ...
    // ... preserved arc data logic or simplified for brevity (using generated approach usually better but for now hardcoded is fine as per previous)
    {
      order: 1,
      startLat: -19.885592,
      startLng: -43.951191,
  ...
  return (
    <section className="py-24 body-color relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-blue-500/10 blur-[100px] rounded-full" />
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        {/* Right Column: Globe */}
        <div className="relative order-2 md:order-2 h-[320px] sm:h-[420px] md:h-[500px] w-full flex items-center justify-center">
          <div className="absolute inset-0 bg-blue-500 blur-[50px] sm:blur-[80px] opacity-20 pointer-events-none" />
          <div className="w-[280px] h-[280px] sm:w-[360px] sm:h-[360px] md:w-[500px] md:h-[500px] relative cursor-move">
